...
//------------------------------------------------------------------------------------------------------------------
CMDOPT_DEFINE_U(verbose     , 'v', "verbose"     ,     "[level]",        0,       nullptr, "Verbosity level");
CMDOPT_DEFINE_Q(fileName    , 'f', "file-name"   ,     "fname",          "",      nullptr, "Name of file to play");

//  case FLAG_LETTER_fileName   : if (processOneCmdOpt(orgStr, optStr,  true, true               , &FLAG_fileName   )) break; else goto USAGE;
//  case FLAG_LETTER_verbose      : if (processOneCmdOpt(orgStr, optStr, false, &FLAG_verbose      , nullptr            )) break; else goto USAGE;
